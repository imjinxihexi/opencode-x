...
export const dict = {
  ...
  "shell.projects.empty": "No open projects",
  "shell.projects.open": "Open project…",
  "shell.projects.remove": "Remove project",
  "shell.workspace.title": "Workspaces",
  "shell.workspace.empty": "No workspaces",
  "shell.workspace.create.title": "New workspace",
  "shell.workspace.create.description": "A workspace groups multiple projects so they share one development context.",
  "shell.workspace.create.name": "Name",
  "shell.workspace.create.namePlaceholder": "e.g. Autonomous driving workspace",
  "shell.workspace.create.prompt": "Workspace prompt",
  "shell.workspace.create.promptPlaceholder": "Shared prompt for every project in this workspace…",
  "shell.workspace.create.promptHint": "Optional. Shared across projects and injected into the workflow context.",
  "shell.workspace.create.submit": "Create",
  "shell.workspace.create.location": "Storage location",
  "shell.workspace.create.folder": "Workspace folder",
  "shell.workspace.create.folderHint": "Cannot contain \\ / : * ? \" < > |. Created under the storage location.",
  "shell.workspace.create.nameInvalid":
    "Name cannot contain \\ / : * ? \" < > |, cannot be only dots/spaces or end with one, max 64 characters.",
  "shell.workspace.create.identifier": "Identifier (folder name)",
  "shell.workspace.create.identifierPlaceholder": "e.g. adas-research",
  "shell.workspace.create.identifierHint": "Folder: {{path}}.",
  "shell.workspace.create.identifierInvalid":
    "Use lowercase letters, numbers, dots, underscores and dashes only. Cannot be only dots/dashes or end with one, max 64 characters.",
  "shell.workspace.create.locationPlaceholder": "Default: ~/opencode-workspaces/<name>",
  "shell.workspace.create.locationHint": "Optional. Folder where this workspace's repos are cloned. The last choice is remembered.",
  "shell.workspace.create.pickFolder": "Choose folder",
  "shell.workspace.create.clearLocation": "Reset",
  "shell.workspace.addRepo.title": "New project",
  "shell.workspace.addRepo.into": "Create into the \"{{workspace}}\" workspace",
  "shell.workspace.addRepo.url": "Git repository URL",
  "shell.workspace.addRepo.urlHint": "Required. HTTPS or SSH clone URL.",
  "shell.workspace.addRepo.name": "Project name",
  "shell.workspace.addRepo.nameHint": "Letters, numbers, dashes and underscores. Defaults to the repository name.",
  "shell.workspace.addRepo.branch": "Branch",
  "shell.workspace.addRepo.branchPlaceholder": "Default branch",
  "shell.workspace.addRepo.branchHint": "Enter a repository URL to load its branches.",
  "shell.workspace.addRepo.submit": "Clone repository",
  "shell.workspace.addRepo.failed": "Clone failed",
  "shell.workspace.grid.overview": "Workspace overview",
  "shell.workspace.grid.search": "Search workspaces",
  "shell.workspace.grid.create": "New workspace",
  "shell.workspace.grid.enter": "Open",
  "shell.workspace.grid.newProject": "Add project",
  "shell.workspace.grid.projects": "{{count}} projects",
  "shell.workspace.grid.noRepo": "No projects",
  "shell.workspace.grid.empty": "No workspaces yet",
  "shell.workspace.detail.title": "Workspace details",
  "shell.workspace.detail.created": "Created {{date}}",
  "shell.workspace.detail.promptHint": "Changes are saved automatically when you click outside the field.",
  "shell.workspace.removeRepo.title": "Remove project?",
  "shell.workspace.removeRepo.description":
    "This only removes the project from the workspace. Files on disk are kept.",
  "shell.workspace.rename.title": "Rename workspace",
  "shell.workspace.delete.title": "Delete workspace?",
  "shell.workspace.delete.description":
    "This only removes the workspace record. The folder and repositories on disk are kept.",
  "shell.git.tab.files": "Files",
  "shell.git.tab.commit": "Commit",
  "shell.git.files": "Files",
  "shell.git.workspace": "Workspace",
  "shell.git.changes": "Changes",
  "shell.git.noChanges": "No changes",
  "shell.git.staged": "Staged",
  "shell.git.unstaged": "Unstaged",
  "shell.git.stage": "Stage",
  "shell.git.unstage": "Unstage",
  "shell.git.stageAll": "Stage all",
  "shell.git.unstageAll": "Unstage all",
  "shell.git.selectRepo": "Select a repository to view changes",
  "shell.git.commit": "Commit",
  "shell.git.messagePlaceholder": "Commit message…",
  "shell.git.commitAndPush": "Commit and push",
  "shell.git.generate.title": "Generate commit message",
  "shell.ai.generateFailed": "AI generation failed",
  "shell.model.auto": "Auto (current model)",
  "shell.git.generate.tooltip": "Generate commit message with AI",
  "shell.git.generate.noModel": "No AI model is available. Configure a provider first.",
  "shell.git.generate.noChanges": "There are no changes to summarize.",
  "shell.git.generate.unsupported": "The current server does not support commit message generation.",
  "shell.git.generate.empty": "The model returned an empty commit message.",
  "shell.git.discard": "Discard",
  "shell.git.push": "Push",
  "shell.git.merge": "Merge",
  "shell.git.createMr": "Create MR",
  "shell.git.history": "History",
  "shell.git.history.noMore": "No more commits",
  "shell.git.noHistory": "No commits",
  "shell.git.mergeInto": "Merge into current branch",
  "shell.git.merge.title": "Merge",
  "shell.git.merge.source": "Source branch",
  "shell.git.merge.target": "Merge into",
  "shell.git.merge.preview": "Merge {{source}} into {{target}}",
  "shell.git.merge.pick": "Select a source and target branch",
  "shell.git.merge.hint": "Choose a branch to merge into {{target}}; the merged commits stay on the current branch",
  ...
  "shell.git.merge.aborting": "Aborting merge…",
  ...
  "shell.git.merge.cleanHint": "{{count}} commits to merge · no conflicts",
  "shell.git.merge.conflictHint": "{{count}} commits to merge · conflicts detected",
  "shell.git.switch.title": "Switch branch · {{repo}}",
  "shell.git.switch.target": "Target branch",
  "shell.git.switch.search": "Search branches",
  "shell.git.switch.favorites": "Favorite branches",
  "shell.git.switch.others": "Other branches",
  "shell.git.switch.remote": "Remote branches",
  "shell.git.switch.fetch": "Fetch",
  "shell.git.switch.noRemote": "No remote branches. Try Fetch.",
  "shell.git.switch.current": "Current",
  "shell.git.switch.favorite": "Favorite",
  "shell.git.switch.copy": "Copy branch name",
  "shell.git.switch.total": "{{count}} branches",
  "shell.git.switch.switching": "Switching branch…",
  "shell.git.switch.success": "Branch switched",
  "shell.git.switch.verifyFailed":
    "Switch did not take effect: current branch is \"{{actual}}\", not \"{{branch}}\".",
  ...
  "shell.git.refresh": "Refresh",
  "shell.git.comingSoon": "Coming in phase 2",
  "shell.git.menu.switch": "Switch branch",
  "shell.git.menu.pull": "Pull",
  "shell.git.menu.refresh": "Refresh",
  "shell.git.menu.delete": "Delete branch",
  "shell.git.menu.newBranch": "New branch",
  "shell.git.newBranch.title": "New branch",
  "shell.git.newBranch.method": "Creation method",
  "shell.git.newBranch.fromRemote": "From latest remote",
  "shell.git.newBranch.fromLocal": "From local current",
  "shell.git.newBranch.source": "Source branch",
  "shell.git.newBranch.name": "New branch name",
  "shell.git.newBranch.namePlaceholder": "New branch name",
  "shell.git.newBranch.create": "Create",
  "shell.git.actionFailed": "Git action failed",
  "shell.git.commitSuccess": "Commit created",
  "shell.git.pushSuccess": "Pushed",
  "shell.git.discardSuccess": "Changes discarded",
  "shell.git.undoCommitSuccess": "Commit undone",
  "shell.git.pullSuccess": "Pulled",
  "shell.git.deleteBranchSuccess": "Branch deleted",
  "shell.git.running": "Committing and pushing…",
  "shell.git.undoCommit": "Undo commit",
  "shell.git.undoCommitConfirm.title": "Undo last commit?",
  "shell.git.undoCommitConfirm.description": "Moves HEAD back one commit and keeps the changes staged.",
  "shell.git.undoCommitConfirm.pushed":
    "This commit already exists on a remote branch. Undoing it rewrites local history and may require a force push.",
  "shell.git.undoRoot.description": "Cannot undo the first commit because it has no parent.",
  "shell.git.pullConflict":
    "Pull produced merge conflicts. Resolve them in the changes panel, then commit.",
  "shell.git.pushRejected.title": "Push rejected",
  "shell.git.pushRejected.description":
    "The remote has commits you do not have locally. Force push with lease? This overwrites the remote branch if it has not changed since your last fetch.",
  "shell.git.pushRejected.confirm": "Force push",
  "shell.git.pushForceSuccess": "Force pushed",
  "shell.git.hunkNewFile": "Individual hunks of an untracked file cannot be staged. Stage the whole file instead.",
  "shell.git.menu.stash": "Stashes",
  "shell.git.stash.title": "Stashes",
  "shell.git.stash.empty": "No stashes",
  "shell.git.stash.create": "Stash current changes",
  "shell.git.stash.apply": "Apply",
  "shell.git.stash.pop": "Pop",
  "shell.git.stash.drop": "Drop",
  "shell.git.deleteBranchForce.title": "Branch not fully merged",
  "shell.git.deleteBranchForce.description":
    "Branch {{name}} contains commits not merged elsewhere. Delete it anyway? Commits may become unreachable.",
  "shell.git.deleteBranchForce.confirm": "Delete anyway",
  "shell.git.conflict.title": "Merge conflicts",
  "shell.git.conflict.abort": "Abort merge",
  "shell.git.conflict.ours": "Ours",
  "shell.git.conflict.theirs": "Theirs",
  "shell.git.conflict.mergeHint": "Left: ours · Right: theirs (editable). Resolve, then save.",
  "shell.git.conflict.save": "Save & mark resolved",
  "shell.git.discardConfirm.title": "Discard all changes?",
  "shell.git.discardConfirm.description":
    "This reverts tracked files and deletes untracked files. This cannot be undone.",
