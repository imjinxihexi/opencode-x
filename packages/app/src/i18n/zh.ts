...
export const dict = {
  ...
  "shell.projects.empty": "暂无打开的项目",
  "shell.projects.open": "打开项目…",
  "shell.projects.remove": "移除项目",
  "shell.workspace.title": "工作空间",
  "shell.workspace.empty": "暂无工作空间",
  "shell.workspace.create.title": "新建工作空间",
  "shell.workspace.create.description": "工作空间用于组织多个项目，方便以同一个研发上下文启动。",
  "shell.workspace.create.name": "名称",
  "shell.workspace.create.namePlaceholder": "例如：智能驾驶研发空间",
  "shell.workspace.create.prompt": "工作空间提示词",
  "shell.workspace.create.promptPlaceholder": "输入工作空间总提示词，空间内所有项目共用…",
  "shell.workspace.create.promptHint": "可选。空间内所有项目共用，将注入到工作流上下文。不确定可留空，之后可在开发页随时修改。",
  "shell.workspace.create.submit": "创建",
  "shell.workspace.create.location": "存储位置",
  "shell.workspace.create.folder": "工作空间文件夹",
  "shell.workspace.create.folderHint": "不能包含 \\ / : * ? \" < > | 等字符；将在存储位置下创建。",
  "shell.workspace.create.nameInvalid": "名称不能包含 \\ / : * ? \" < > | 等字符，不能全为点/空格或以点、空格结尾，最长 64 字符。",
  "shell.workspace.create.identifier": "标识（文件夹名）",
  "shell.workspace.create.identifierPlaceholder": "例如：adas-research",
  "shell.workspace.create.identifierHint": "目录：{{path}}。",
  "shell.workspace.create.identifierInvalid": "仅支持小写英文、数字、点、下划线和横线，不能全为点/横线或以其结尾，最长 64 字符。",
  "shell.workspace.create.locationPlaceholder": "默认：~/opencode-workspaces/<名称>",
  "shell.workspace.create.locationHint": "可选。该工作空间克隆仓库的存放文件夹，会记住上次选择。",
  "shell.workspace.create.pickFolder": "选择文件夹",
  "shell.workspace.create.clearLocation": "恢复默认",
  "shell.workspace.addRepo.title": "新建项目",
  "shell.workspace.addRepo.into": "创建到「{{workspace}}」工作空间",
  "shell.workspace.addRepo.url": "Git 仓库地址",
  "shell.workspace.addRepo.urlHint": "必填，用于克隆代码仓库。支持 HTTPS 地址，以及 SSH 地址。",
  "shell.workspace.addRepo.name": "项目名称",
  "shell.workspace.addRepo.nameHint": "仅支持英文、数字、下划线和横线，默认从仓库地址自动生成。",
  "shell.workspace.addRepo.branch": "分支",
  "shell.workspace.addRepo.branchPlaceholder": "默认分支",
  "shell.workspace.addRepo.branchHint": "填写仓库地址后可获取可选分支。",
  "shell.workspace.addRepo.submit": "克隆仓库",
  "shell.workspace.addRepo.failed": "克隆失败",
  "shell.workspace.grid.overview": "工作区总览",
  "shell.workspace.grid.search": "搜索工作区",
  "shell.workspace.grid.create": "新建工作空间",
  "shell.workspace.grid.enter": "进入开发",
  "shell.workspace.grid.newProject": "添加项目",
  "shell.workspace.grid.projects": "{{count}} 个项目",
  "shell.workspace.grid.noRepo": "暂无项目",
  "shell.workspace.grid.empty": "暂无工作空间",
  "shell.workspace.detail.title": "工作空间详情",
  "shell.workspace.detail.created": "创建于 {{date}}",
  "shell.workspace.detail.promptHint": "点击输入框外自动保存。",
  "shell.workspace.removeRepo.title": "移除项目？",
  "shell.workspace.removeRepo.description": "仅从工作空间移除该项目记录，不会删除磁盘文件。",
  "shell.workspace.rename.title": "重命名工作空间",
  "shell.workspace.delete.title": "删除工作空间？",
  "shell.workspace.delete.description": "仅移除工作空间记录，不会删除磁盘上的文件夹和仓库。",
  "shell.git.tab.files": "文件",
  "shell.git.tab.commit": "提交",
  "shell.git.files": "文件",
  "shell.git.workspace": "工作区",
  "shell.git.changes": "改动",
  "shell.git.noChanges": "没有改动",
  "shell.git.staged": "已暂存",
  "shell.git.unstaged": "未暂存",
  "shell.git.stage": "暂存",
  "shell.git.unstage": "取消暂存",
  "shell.git.stageAll": "全部暂存",
  "shell.git.unstageAll": "全部取消暂存",
  "shell.git.selectRepo": "选择一个仓库查看改动",
  "shell.git.commit": "提交",
  "shell.git.messagePlaceholder": "输入提交信息…",
  "shell.git.commitAndPush": "提交并推送",
  "shell.git.generate.title": "生成提交信息",
  "shell.ai.generateFailed": "AI 生成失败",
  "shell.model.auto": "自动（跟随当前模型）",
  "shell.git.generate.tooltip": "用 AI 生成提交信息",
  "shell.git.generate.noModel": "没有可用的 AI 模型，请先配置服务商。",
  "shell.git.generate.noChanges": "没有可用于生成提交信息的改动。",
  "shell.git.generate.unsupported": "当前服务器不支持生成提交信息。",
  "shell.git.generate.empty": "模型未返回提交信息。",
  "shell.git.discard": "放弃变更",
  "shell.git.push": "推送",
  "shell.git.merge": "合并",
  "shell.git.createMr": "发起 MR",
  "shell.git.history": "历史",
  "shell.git.history.noMore": "没有更多提交",
  "shell.git.noHistory": "暂无提交",
  "shell.git.mergeInto": "合并到当前分支",
  "shell.git.merge.title": "合并",
  "shell.git.merge.source": "源分支",
  "shell.git.merge.target": "合并到",
  "shell.git.merge.preview": "把 {{source}} 合并到 {{target}}",
  "shell.git.merge.pick": "请选择源分支和目标分支",
  "shell.git.merge.hint": "选择一个分支合并到 {{target}}，合并后的提交将保留在当前分支",
  "shell.git.merge.pickSource": "选择分支",
  "shell.git.merge.confirm": "确认",
  "shell.git.merge.success": "合并成功",
  "shell.git.merge.running": "正在合并…",
  "shell.git.merge.aborting": "正在放弃合并…",
  "shell.git.merge.abortSuccess": "已放弃合并",
  "shell.git.merge.dirty": "工作区有未提交改动，请先提交或暂存",
  "shell.git.merge.checkoutFailed": "切换目标分支失败，已中止合并",
  "shell.git.merge.cleanHint": "将合并 {{count}} 个提交 · 无冲突",
  "shell.git.merge.conflictHint": "将合并 {{count}} 个提交 · 存在冲突",
  "shell.git.switch.title": "切换分支 · {{repo}}",
  "shell.git.switch.target": "目标分支",
  "shell.git.switch.search": "搜索分支",
  "shell.git.switch.favorites": "收藏分支",
  "shell.git.switch.others": "未收藏分支",
  "shell.git.switch.remote": "远程分支",
  "shell.git.switch.fetch": "获取",
  "shell.git.switch.noRemote": "暂无远程分支，可点「获取」",
  "shell.git.switch.current": "当前",
  "shell.git.switch.favorite": "收藏",
  "shell.git.switch.copy": "复制分支名",
  "shell.git.switch.total": "共 {{count}} 个分支",
  "shell.git.switch.switching": "正在切换分支…",
  "shell.git.switch.success": "已切换分支",
  "shell.git.switch.verifyFailed": "切换未生效：当前分支为「{{actual}}」，与目标「{{branch}}」不一致。",
  "shell.git.dirtySwitch.title": "有未提交的改动",
  "shell.git.dirtySwitch.description": "当前工作区有未提交改动。继续会把改动带到「{{branch}}」；也可先暂存再切换。",
  "shell.git.dirtySwitch.continue": "继续切换",
  "shell.git.dirtySwitch.stash": "暂存后切换",
  "shell.git.noDiff": "无差异内容",
  "shell.git.diff.unified": "单栏视图",
  "shell.git.diff.split": "分栏视图",
  "shell.git.refresh": "刷新",
  "shell.git.comingSoon": "阶段二支持",
  "shell.git.menu.switch": "切换分支",
  "shell.git.menu.pull": "拉取",
  "shell.git.menu.refresh": "刷新",
  "shell.git.menu.delete": "删除分支",
  "shell.git.menu.newBranch": "新建分支",
  "shell.git.newBranch.title": "新建分支",
  "shell.git.newBranch.method": "创建方式",
  "shell.git.newBranch.fromRemote": "基于远程最新代码",
  "shell.git.newBranch.fromLocal": "基于本地当前代码",
  "shell.git.newBranch.source": "源分支",
  "shell.git.newBranch.name": "新分支名称",
  "shell.git.newBranch.namePlaceholder": "新分支名",
  "shell.git.newBranch.create": "创建",
  "shell.git.actionFailed": "Git 操作失败",
  "shell.git.commitSuccess": "提交成功",
  "shell.git.pushSuccess": "推送成功",
  "shell.git.discardSuccess": "已放弃变更",
  "shell.git.undoCommitSuccess": "已撤销提交",
  "shell.git.pullSuccess": "拉取成功",
  "shell.git.deleteBranchSuccess": "已删除分支",
  "shell.git.running": "正在提交并推送…",
  "shell.git.undoCommit": "撤销提交",
  "shell.git.undoCommitConfirm.title": "撤销上次提交？",
  "shell.git.undoCommitConfirm.description": "将 HEAD 回退一次提交，改动保留为已暂存。",
  "shell.git.undoCommitConfirm.pushed": "该提交已存在于远程分支，撤销会改写本地历史，可能之后需要强制推送。",
  "shell.git.undoRoot.description": "这是首个提交，没有父提交，无法撤销。",
  "shell.git.pullConflict": "拉取产生了合并冲突，请在“改动”面板中解决后提交。",
  "shell.git.pushRejected.title": "推送被拒绝",
  "shell.git.pushRejected.description":
    "远程有你本地没有的提交。是否使用 force-with-lease 强制推送？若远程自上次拉取后未变更，将覆盖远程分支。",
  "shell.git.pushRejected.confirm": "强制推送",
  "shell.git.pushForceSuccess": "已强制推送",
  "shell.git.hunkNewFile": "未跟踪文件无法按代码块暂存，请暂存整个文件。",
  "shell.git.menu.stash": "暂存管理",
  "shell.git.stash.title": "暂存管理",
  "shell.git.stash.empty": "暂无暂存",
  "shell.git.stash.create": "暂存当前改动",
  "shell.git.stash.apply": "应用",
  "shell.git.stash.pop": "弹出",
  "shell.git.stash.drop": "删除",
  "shell.git.deleteBranchForce.title": "分支尚未完全合并",
  "shell.git.deleteBranchForce.description":
    "分支 {{name}} 含有未合并到其他位置的提交。仍要删除吗？这些提交可能变得不可达。",
  "shell.git.deleteBranchForce.confirm": "仍要删除",
  "shell.git.conflict.title": "存在合并冲突",
  "shell.git.conflict.abort": "放弃合并",
  "shell.git.conflict.ours": "用本地",
  "shell.git.conflict.theirs": "用远程",
  "shell.git.conflict.mergeHint": "左：本地 · 右：远程（可编辑）。解决后点保存。",
  "shell.git.conflict.save": "保存并标记已解决",
  "shell.git.discardConfirm.title": "放弃所有变更？",
  "shell.git.discardConfirm.description": "将还原已跟踪文件并删除未跟踪文件，不可撤销。",
