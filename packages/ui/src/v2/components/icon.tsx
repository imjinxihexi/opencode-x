...
const icons = {
  ...
  warning: {
    viewBox: "0 0 16 16",
    body: `<path d="M7.1 2.5a1.05 1.05 0 0 1 1.8 0l5.35 9.3a1.05 1.05 0 0 1-.9 1.57H2.65a1.05 1.05 0 0 1-.9-1.57L7.1 2.5Z" stroke="currentColor" stroke-linejoin="round"/><path d="M8 6.2v3.1" stroke="currentColor" stroke-linecap="round"/><circle cx="8" cy="11.4" r="0.75" fill="currentColor"/>`,
  },
  cloud: {
    viewBox: "0 0 16 16",
    body: `<path d="M5 12.3a3 3 0 0 1-.4-5.95A4 4 0 0 1 11.9 5.9a2.9 2.9 0 0 1 .4 5.7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 7.6V13.1M6.4 11.5 8 13.1l1.6-1.6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
}
